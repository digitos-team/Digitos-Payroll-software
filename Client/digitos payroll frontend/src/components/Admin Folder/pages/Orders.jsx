...
//               <div className="text-sm space-y-1">
//                 <div><span className="text-gray-600">Client:</span> {orderDetails.order?.ClientName}</div>
...
//                 <div><span className="text-gray-600">GST Type:</span> {orderDetails.order?.GSTType || "N/A"}</div>
//                 {orderDetails.order?.GSTType === "IGST" ? (
//                   <div><span className="text-gray-600">IGST:</span> ₹{orderDetails.order?.IGSTAmount?.toFixed(2)}</div>
//                 ) : (
//                   <>
//                     <div><span className="text-gray-600">CGST:</span> ₹{orderDetails.order?.CGSTAmount?.toFixed(2)}</div>
...
//                 <div className="font-semibold"><span className="text-gray-600">Final Amount:</span> ₹{orderDetails.order?.Amount?.toLocaleString()}</div>
//               </div>
//             </div>
//             <div>
...
//                 <div><span className="text-gray-600">Estimated Profit:</span> ₹{orderDetails.summary?.estimatedProfit?.toLocaleString()}</div>
//               </div>
//             </div>
//           </div>
//         </div>
              ...
              <div className="text-sm space-y-1">
                ...
                {orderDetails.order?.ClientAddress && (
                  <div className="mt-2 pt-2 border-t">
                    ...
                    {orderDetails.order.ClientAddress.street && (
                      <div className="text-xs">{orderDetails.order.ClientAddress.street}</div>
                    )}
                    <div className="text-xs">
                      {[
                        orderDetails.order.ClientAddress.city,
                        orderDetails.order.ClientAddress.state,
                        orderDetails.order.ClientAddress.pincode
                      ].filter(Boolean).join(", ")}
                    </div>
                  </div>
                )}
